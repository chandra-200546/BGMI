        ...
        {realLobbies.length ? (
          <div className="mt-12 grid gap-6 md:grid-cols-2">
            {realLobbies.map((lobby, index) => (
              <div
                key={lobby.id ?? index}
                className="hud-panel border border-sky-400/25 p-6 transition hover:border-sky-400 bg-slate-950"
              >
                <div className="flex items-center justify-between">
                  <span className="flex items-center gap-2 font-mono text-xs uppercase tracking-[0.2em] text-sky-400 font-bold">
